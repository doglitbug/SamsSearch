...
void SettingsMenu::onEnter() {
    ...
    m_gameObjects.push_back(generateButton("|<", [this] { s_menuTitleMusicOff(); }, 50));
    m_gameObjects.push_back(generateLabelBool([this]()->bool{ return m_pSettings->getTitleMusicEnabled();}));
    m_gameObjects.push_back(generateButton(">|", [this]{s_menuTitleMusicOn();}, 50));

    m_gameObjects.push_back(generateLabel("Game Music", 300));
    m_gameObjects.push_back(generateButton("|<", [this]{s_menuGameMusicOff();}, 50));
    ...
    m_gameObjects.push_back(generateButton(">", [this]{s_menuGameVolumeUp();}, 50));
